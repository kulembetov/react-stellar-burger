...
import { ILoginErrors } from '../../services/types/data';
...
const Login = () => {
  ...
  const [errors, setErrors] = useState<ILoginErrors>(initialErrors);
  ...
  const handleBlur = (field: keyof ILoginErrors) => {
  ...
  const handleFocus = (field: keyof ILoginErrors) => {
